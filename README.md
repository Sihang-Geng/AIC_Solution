...
我们是 Algorithm Challenge 图书借阅推荐赛 **初赛第一名** 的「噜啦啦」队，最终获 **国家一等奖**。比赛结束后，我们将最终提交方案与核心实现开源，部分目录结构、脚本命名和中间结果仍保留了比赛阶段的迭代痕迹。相比于只给出一个干净的最终版本，我们更希望把真实数据中有效的建模思路、融合方式和取舍过程保留下来，给后续参赛者和推荐系统学习者带来一点思路参考。
