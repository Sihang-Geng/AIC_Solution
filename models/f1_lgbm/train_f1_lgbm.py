...
class Config:
    ...
    OUTPUT_FILE = 'f1data.csv'

    # Cache paths
    TEXT_PIPELINE_PATH = 'text_pipeline_reborrow_final.joblib'
    MODEL_SAVE_PATH = 'lgb_model_reborrow_final.joblib'
    FEATURE_LIST_PATH = 'lgb_features_reborrow_final.pkl'
