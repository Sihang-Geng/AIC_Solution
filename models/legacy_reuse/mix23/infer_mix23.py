...
# --- Output File Paths ---
TOP_RECOMMENDATIONS_OUTPUT_FILE = '1复赛时f23的final_recommendations.csv'
TOP1_RECOMMENDATIONS_OUTPUT_FILE = '1复赛时的f23混推.csv'
# --- Model & Preprocessor Save Paths ---
MODEL_2ND_BORROW_PATH = '1复赛时的f23lgbm_model_2nd.joblib'
PREPROCESSOR_2ND_BORROW_PATH = '1复赛时的f23preprocessor_2nd.joblib'
MODEL_3RD_BORROW_PATH = '1复赛时的f23lgbm_model_3rd.joblib'
PREPROCESSOR_3RD_BORROW_PATH = '1复赛时的f23preprocessor_3rd.joblib'
