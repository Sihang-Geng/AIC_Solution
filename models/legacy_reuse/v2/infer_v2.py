...
DATA_FILE = '1data.csv'
OUTPUT_FILE = '1复赛时的fv2.csv'
TOP10_OUTPUT_FILE = '1复赛时的v2top10_recommendations.csv'  # 新增：top10推荐输出文件
MODEL_SAVE_PATH = '1复赛时的fv2lgbm_recommender.joblib'
PREPROCESSOR_SAVE_PATH = '1复赛时的fv2preprocessor_v2.joblib'
